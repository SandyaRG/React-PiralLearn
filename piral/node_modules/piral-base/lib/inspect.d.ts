import type { PiletEntry, PiletV0Entry, PiletV1Entry, PiletV2Entry, PiletV3Entry, PiletBundleEntry, PiletRunner } from './types';
...
export type InspectPiletResult = InspectPiletV0 | InspectPiletV1 | InspectPiletV2 | InspectPiletV3 | InspectPiletUnknown | InspectPiletBundle;
export declare function inspectPilet(meta: PiletEntry): InspectPiletResult;
